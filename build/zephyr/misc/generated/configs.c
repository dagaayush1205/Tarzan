...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SYS_CLOCK_HW_CYCLES_PER_SEC, 280000000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_KYVERNITIS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_KYVERNITIS_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CANARD, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_CANARD_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CANSCRIBE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_CANSCRIBE_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NUCLEO_H7A3ZI_Q, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NUCLEO_H7A3ZI_Q_STM32H7A3XX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_STM32H7A3XXQ, 1);
